...
import com.ljla.yourfuture.domain.usecase.GetPredictionUseCase
    ...
    fun getHoroscope(sign: HoroscopeModel) {
        ...
        viewModelScope.launch {
            ...
            if (result != null) {
                ...
                _state.value = HoroscopeDetailState.Error("Ha ocurrido un error. Intentelo de nuevo mas tarde")
            }
